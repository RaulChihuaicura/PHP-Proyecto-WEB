...
Class Usuario
{
    ...
    public function insertar($nombre, $rut, $telefono, $email, $cargo, $login, $clave, $imagen, $permisos)
    {
        $sql = "INSERT INTO usuario (nombre, rut,  telefono, email, cargo, login, clave, imagen, condicion)
                VALUES ('$nombre','$rut', '$telefono', '$email', '$cargo', '$login', '$clave', '$imagen', '1')";
    ...
    public function editar($idusuario, $nombre, $rut, $telefono, $email, $cargo, $login, $clave, $imagen, $permisos)
    {

...
switch ($_GET["op"]){
    case 'guardaryeditar':
        ...
        if (empty($idusuario)){
                $rspta=$usuario->insertar($nombre, $rut, $telefono, $email, $cargo, $login, $clavehash, $imagen, $_POST['permiso']);
            echo $rspta ? "Usuario registrado" : "No se pudieron registrar todos los datos los datos del Usuario";
        }
        else
        {
            $rspta=$usuario->editar($idusuario, $nombre, $rut, $telefono, $email, $cargo, $login, $clavehash, $imagen, $_POST['permiso']);
    ...
    case 'permisos':
        ...
        //declaracion de array para almacenar todos los permisos marcados
        $valores=array();
    ...
    case 'verificar':
        ...
        if (isset($fetch))
        {
            ...
            in_array(2,$valores)?$_SESSION['consulta']=1:$_SESSION['consulta']=0;
